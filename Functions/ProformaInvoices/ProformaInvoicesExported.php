...
/**
 * @see https://app.idoklad.cz/developer/Help/v2/cs/Api?apiId=PUT-api-v2-ProformaInvoices-id-Exported-exported
 *
 * @author Lukáš Brzák <brzak@fousky.cz>
 */
class ProformaInvoicesExported extends iDokladAbstractFunction
{
    /** @var string $id */
    protected $id;
