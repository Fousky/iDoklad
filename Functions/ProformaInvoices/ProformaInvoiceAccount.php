...
/**
 * @see https://app.idoklad.cz/developer/Help/v2/cs/Api?apiId=PUT-api-v2-ProformaInvoices-id-Account
 *
 * @author Lukáš Brzák <brzak@fousky.cz>
 */
class ProformaInvoiceAccount extends iDokladAbstractFunction
{
    /** @var string $id */
    protected $id;
