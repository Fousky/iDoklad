...
/**
 * @see https://app.idoklad.cz/developer/Help/v2/cs/Api?apiId=PUT-api-v2-IssuedDocumentPayments-id-Exported-exported
 *
 * @author Lukáš Brzák <brzak@fousky.cz>
 */
class UpdateIssuedDocumentPaymentExported extends iDokladAbstractFunction
{
    /** @var string $id */
    protected $id;
    ...
    {
        return sprintf(
            'IssuedDocumentPayments/%s/Exported/%s',
            $this->id,
            $this->exported
        );
    }
