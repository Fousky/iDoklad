...
/**
 * @see https://app.idoklad.cz/developer/Help/v2/cs/Api?apiId=GET-api-v2-ReceivedDocumentPayments-id
 *
 * @author Lukáš Brzák <brzak@fousky.cz>
 */
class GetReceivedDocumentPayment extends iDokladAbstractFunction
{
    /** @var string $id */
    protected $id;
